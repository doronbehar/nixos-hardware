...
- No NVMe boot on Pi 5: it needs BCM2712 PCIe support in U-Boot, which is still [in review upstream](https://lists.denx.de/pipermail/u-boot/2026-June/620499.html) and not in a tagged release. `ubootRaspberryPiAarch64` picks it up once nixpkgs ships a U-Boot that has it.
